...
func (mr *MockResolverRepositoryMockRecorder) Delete(ctx, apiID, typeName, fieldName interface{}) *gomock.Call {
...
func (mr *MockResolverRepositoryMockRecorder) Get(ctx, apiID, typeName, fieldName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockResolverRepositoryMockRecorder) List(ctx, apiID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockResolverRepositoryMockRecorder) ListByTypeName(ctx, apiID, typeName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockResolverRepositoryMockRecorder) Save(ctx, apiID, resolver interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
