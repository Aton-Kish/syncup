...
func (mr *MockAWSActivatorMockRecorder) ActivateAWS(ctx interface{}, optFns ...interface{}) *gomock.Call {
...
func (mr *MockBaseDirProviderMockRecorder) BaseDir(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockBaseDirProviderMockRecorder) SetBaseDir(ctx, dir interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ActivateAWS indicates an expected call of ActivateAWS.
func (mr *MockRepositoryMockRecorder) ActivateAWS(ctx interface{}, optFns ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx}, optFns...)
...
// BaseDir indicates an expected call of BaseDir.
func (mr *MockRepositoryMockRecorder) BaseDir(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetBaseDir indicates an expected call of SetBaseDir.
func (mr *MockRepositoryMockRecorder) SetBaseDir(ctx, dir interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
